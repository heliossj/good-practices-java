...
class AbrigoControllerTest {
    ...
    void deveriaDevolverCodigo400ParaRequisicaoDeListarPetsDoAbrigoPorIdInvalido() throws Exception {
        //Arrange
        String id = "1";
        given(abrigoService.listarPetsAbrigo(id)).willThrow(ValidacaoException.class);
    ...
    void deveriaDevolverCodigo400ParaRequisicaoDeListarPetsDoAbrigoPorNomeInvalido() throws Exception {
        //Arrange
        String nome = "Miau";
        given(abrigoService.listarPetsAbrigo(nome)).willThrow(ValidacaoException.class);
